...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params["W2"] = np.random.normal(0.0, weight_scale, (int(num_filters * (H * W / 4.0)), hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        out_1, cache_1 = conv_lrelu_pool_forward(X, W1, b1, conv_param, {'alpha': self.alpha}, pool_param)
        ...
        dout_1, grads["W2"], grads["b2"] = affine_lrelu_backward(dout_2, cache_2)
        d_x, grads["W1"], grads["b1"] = conv_lrelu_pool_backward(dout_1, cache_1)
